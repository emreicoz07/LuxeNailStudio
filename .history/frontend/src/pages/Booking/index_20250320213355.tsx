...
const BookingPage: React.FC = () => {
  ...
  const handleServiceSelect = (serviceId: string) => {
    ...
    // Scroll to add-ons section with offset for the navbar and sticky header
    setTimeout(() => {
      if (addOnsSectionRef.current) {
        const yOffset = -120; // Navbar ve sticky header için daha fazla boşluk
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <AnimatePresence mode="wait">
          ...
          {currentStep === 'service' && selectedService && (
            ...
            >
              <div className="border-t border-gray-200 pt-8" ref={addOnsSectionRef}>
                <div className="sticky top-16 bg-white py-4 z-50 border-b border-gray-100 shadow-sm">
